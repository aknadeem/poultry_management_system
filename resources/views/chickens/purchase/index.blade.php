                ...
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-6 align-self-end text-end mb-2">
                            <a class="btn btn-secondary btn-sm" href="{{ route('purchase.create') }}"
                    ...
                    <table id="ChickenPurchase-datatable" class="table table-striped dt-responsive w-100">
                        <thead>
                            <th>#</th>
                            <th>picture</th>
                            <th>Company</th>
...
@include('chickens._ChickenPurchaseModal')
...
<script>
    $(function() {
        ...
        $('#ChickenPurchase-datatable').DataTable({
            processing: true,
            info: true,
            ajax: "{{ route('getpurchaselist')}}",
            "pageLength":10,
