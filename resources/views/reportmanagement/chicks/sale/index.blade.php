            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ChickenSales</li>
                    </ol>
                </div>
                <h4 class="page-title">Chicken Sales Report </h4>
            </div>
        </div>
    </div>
...
<script>
    $(function() {
        ...
        $('#ReportSearchForm').on('submit', function(e) {
            ...
            // alert(Fromdate)
            var uri = "{{ url('reportmanagement/chick-sale-report') }}/"+Fromdate+"/"+toDate
