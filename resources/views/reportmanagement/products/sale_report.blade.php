            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ProductSaleReport</li>
                    </ol>
                </div>
                <h4 class="page-title">Product Sale Report</h4>
            </div>
        </div>
    </div>
...
<script>
    $(function() {
        ...
        $('#ReportSearchForm').on('submit', function(e) {
            ...
            // alert(Fromdate)
            var uri = "{{ url('reportmanagement/product-sale/report') }}/"+Fromdate+"/"+toDate
