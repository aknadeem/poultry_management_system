...
<div id="AddFeedModal" class="modal fade" data-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="AddFeedModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header border-bottom">
                <h4 class="modal-title" id="standard-modalLabel"> <span class="AddUpdate"> Add </span> Feed Purchase
                </h4>
                ...
                <form autocomplete="off" method="post" enctype="multipart/form-data" id="FeedEntryForm">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-4 mb-2">
                            ...
                            <input type="text" placeholder="Enter Sale Order Number" name="sale_order_number" value=""
                        ...
                        <div class="col-sm-4 mb-2">
                            ...
                            <input type="text" placeholder="Enter Delivery Order Number" name="delivery_order_number"
                                value="" class="form-control" id="Do_Number">
