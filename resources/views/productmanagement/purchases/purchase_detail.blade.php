            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('productpurchases.index') }}">ProductPurchase</a>
                        </li>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mt-1">
                                <p class="fs-5">
                                    <b>{{ $purchase?->company?->company_name}}</b>
                                    <b>[{{ $purchase?->productcategory?->name}}]</b>
                                </p>
                                <p class="text-muted">Thanks a lot because you keep selling your products to us. </p>
                            </div>

                        </div><!-- end col -->
                        <div class="col-6">
                            <div class="mt-1 float-end">
                                <p class="mb-1"><strong> Date : </strong> <span class="float-end">
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        {{$purchase?->purchase_date?->format('d M, Y')}} </span></p>
                                <p class="mb-1"><strong> Payment Status: </strong> <span class="float-end">
                                        <span class="badge bg-{{$purchase?->status_value['color_name']}}">
                                            {{$purchase?->status_value['value']}} </span>
                                    </span>
                                </p>
                                <p class="mb-1"><strong> Purchase Code : </strong> <span
                                        class="float-end">{{$purchase?->purchase_code}} </span>
                                </p>
                            </div>
                        </div><!-- end col -->
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="float-end fs-5">
                                ...
                                @php
                                $perr = $purchase?->discount_amount/$purchase?->total_amount*100;

                                @endphp
                                <p><b>Discount ({{number_format($perr, 2)}}%):</b> <span class="float-end">
                                        &nbsp;&nbsp;&nbsp;
                                        @money($purchase?->discount_amount) </span></p>
