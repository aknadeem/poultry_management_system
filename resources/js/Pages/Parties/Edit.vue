...
<template>
    <div class="container-fluid">
        <PageTitle title="Create Party" :crumbs="['Home', 'PartyManagement', 'Create']" />
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <PartyForm
                            ...
                            method="put"
                            :party="party"
                            :submit-url="route('inertia.parties.update', props.party)"
                            :index-url="route('inertia.parties.index')"
                            :countries="countries"
                            :divisions="divisions"
