...
<template>
    <div class="container-fluid">
        <PageTitle title="Customers" :crumbs="['Home', 'Customer', 'Edit']" />
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <PartyForm
                            mode="customer"
                            form-title="Create Customer"
                            method="put"
                            :party="party"
                            :submit-url="route('inertia.customers.update', props.party)"
                            :index-url="route('inertia.customers.index')"
                            :countries="countries"
                            :divisions="divisions"
                            :customer-types="customerTypes"
                            :farm-types="farmTypes"
                            :farm-subtypes="farmSubtypes"
