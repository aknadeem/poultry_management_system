...
const props = defineProps({
    formTitle: { type: String, default: 'Add Purchase Entry' },
...
function onSelectProduct(event) {
    ...
    draft.value.product_sale_price = product.purchase_price;
    recalcDraft();
}
...
<template>
    <div>
        ...
        <form id="ProductPurchaseForm" autocomplete="off" @submit.prevent="submit">
            <div class="row">
                <div class="col-3 border border-2">
                    <div class="row mt-2">
                        <div class="col-12 mb-3">
                            <label class="font_bold">Select Group*</label>
                            <select v-model="form.product_group" class="form-control" required>
                        ...
                        <div class="col-12 mb-3">
                            <label class="font_bold">Purchase Date</label>
                            <input v-model="form.purchase_date" class="form-control" type="date">
                            <FormError :message="form.errors.purchase_date" />
                        </div>
                        <div class="col-12 mb-3">
                            <label class="font_bold">Expiry Date</label>
                            <input v-model="form.expiry_date" class="form-control" type="date">
                            <FormError :message="form.errors.expiry_date" />
                        </div>
                    </div>
                </div>
